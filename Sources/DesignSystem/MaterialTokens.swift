...
extension DesignTokens {
    ...
    public enum Material {
        /// 玻璃态材质 (超薄)
        public static let glassUltra = SwiftUI.Material.ultraThinMaterial
        /// 玻璃态材质 (薄)
        ...
        /// 玻璃态材质 (超厚)
        public static let glassUltraThick = SwiftUI.Material.ultraThickMaterial

        /// 神秘氛围材质（根据配色方案调整）
        /// - Parameter scheme: 当前配色方案
        /// - Returns: 形状样式
        public static func mysticGlass(for scheme: ColorScheme) -> some ShapeStyle {
            switch scheme {
            case .light:
                // 浅色模式：使用白色半透明材质
